...
const Login = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-[92vh] flex items-center justify-center">
      <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-4xl p-5 items-center">
        ...
        <div className="md:block hidden w-1/2">
          <img
            ...
            src="https://images.unsplash.com/photo-1554647286-f365d7defc2d?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=687&q=80"
            alt="login"
          />
        </div>
      </div>
